...
<table style="margin:10px auto; width:900px;" class="iguales2">
	...
	<tr>
		...
		<td colspan="2"><?php echo $promedio_dias .' día(s) '; ?></td>		
	</tr>
	<tr>
...
<form id="reporte_cr" action="{{route('reportes_especificos_add_bd')}}" class="col-auto" method="post">
<center>
	@if(session('tipo_dep') == 'CA')
		...
		<input type="hidden" id="tipo" name="tipo" value="CDRE">
