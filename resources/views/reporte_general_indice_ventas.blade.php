...
<form id="reporte_general_iv" action="{{route('reportes_generales_add_db')}}" class="col-auto" method="post">
<center>
	@if(session('tipo_dep') == 'CA')
		...
		<input type="hidden" id="empresa" name="empresa" value="{{$empresa->id_emp}}">
		<input type="hidden" id="tipo" name="tipo" value="CIVG">
