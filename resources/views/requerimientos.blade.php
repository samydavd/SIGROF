...
<header class="page-header">
    <div class="container-fluid-title">
        <h3 class="no-margin-bottom">Listado de Requisiciones</h3>
    </div>
</header>
  ...
  $(function () {
    ...
    requisiciones.forEach(function(v){
      ...
      if (v.tipo == 'S'){
        ...
        var prioridad = '<a href="{{asset('storage/ordenes/PO38.pdf')}}" target="_blank"><div data-toggle="tooltip" data-placement="top" style="padding-right:6px" title="Orden de compra creada"><img src="{{asset('img/PO.png')}}" style="width: 16px; height: 16px;"></div></a>';
      }
